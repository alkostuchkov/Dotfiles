...
sleep 60
# cp ~/.config/xfce4/desktop/icons.screen0-1264x982_backup.rc ~/.config/xfce4/desktop/icons.screen0-1264x982.rc
# sleep 2
# xfdesktop --reload
...
if [ -z ${idConky} ]; then
    ...
    #sleep 3
    exec conky -c ~/.myScripts/conky/conkyrc1_xfce 2>&1 > /dev/null &
else
    kill -9 $idConky
