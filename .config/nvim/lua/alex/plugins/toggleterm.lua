return {
  ...
  config = function()
    ...
    function _G.set_terminal_keymaps()
      ...
      vim.keymap.set('t', '<C-S-h>', [[<Cmd>wincmd h<CR>]], opts)
      vim.keymap.set('t', '<C-S-j>', [[<Cmd>wincmd j<CR>]], opts)
      vim.keymap.set('t', '<C-S-k>', [[<Cmd>wincmd k<CR>]], opts)
      vim.keymap.set('t', '<C-S-l>', [[<Cmd>wincmd l<CR>]], opts)
    end
