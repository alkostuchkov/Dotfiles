...
"}}}
" {{{ Colors
  let s:base00 = ['#26394d', '235']
  let s:base01 = ['#203040', '237']
  let s:base02 = ['#152535', '240']
  ...
  let s:red    = ['#ff6666', '203']
  let s:orange = ['#e6ac74', '209']
  let s:yellow = ['#e6e600', '221']
  let s:green  = ['#00e673', '114']
  let s:cyan   = ['#00b3b3', '73']
  let s:blue   = ['#66b2ff', '68']
  let s:purple = ['#b366ff', '176']
  let s:brown  = ['#ab7967', '137']
  let s:white  = ['#f0f0f0', '15']
