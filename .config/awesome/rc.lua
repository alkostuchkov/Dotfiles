...
my_textclock = wibox.widget.textclock()
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey            }, "d",
    function ()
        awful.spawn(string.format("dmenu_run -nb '#263238' -nf '#24d2af' -sb '#009185' -p 'Run: ' -fn 'Ubuntu-18:normal'"))
	end,
    {description = "show dmenu", group = "hotkeys"}),

    -- My dmenu scripts (Alt+Ctrl+Key)
    awful.key({ altkey, "Control" }, "x", function () awful.util.spawn(home .. "/.myScripts/dmenu/dmenu-system-exit.sh") end,
        {description = "system menu" , group = "dmenu scripts" }),
...
-- "{home}/.myScripts/dmenu/dmenu-system-exit.sh"
    -- }}}

    -- <SUPER> + FUNCTION KEYS
    awful.key({ modkey,           }, "s",      hotkeys_popup.show_help,
              {description="show help", group="awesome"}),
    -- Switch between tags (desktops)
    awful.key({ modkey,           }, "Left",   awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    awful.key({ modkey,           }, "Right",  awful.tag.viewnext,
              {description = "view next", group = "tag"}),
    -- Switch between current and previous tags
    ...
    -- Change client focus by direction 
    awful.key({ modkey }, "j",
        function()
    ...
    -- -- Change client focus by index (default)
    -- awful.key({ altkey,           }, "j",
        -- function ()
            -- awful.client.focus.byidx( 1)
        -- end,
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.util.spawn("rofi run -show drun -show-icons") end,
                  ...
                  function ()
                      if client.focus then
                          ...
                          if tag then
                              ...
                              tag:view_only() -- And switch to this tag
                          end
                     end
                  end,
...
run_once({
    ...
    "conky -c " .. home .. "/.myScripts/conky/conkyrc1",
...
-- TODO???
-- Run once separately cause not to generate proccesses like:
-- /usr/bin/fish -c pgrep -u $USER -fx 'diodon' > /dev/null || diodon
-- awful.spawn.with_shell("setxkbmap -layout us,ru -option grp:caps_toggle")
-- awful.spawn.with_shell("diodon")
-- awful.spawn.with_shell("BreakTimer.AppImage")
