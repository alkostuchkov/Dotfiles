...
local function worker(user_args)
    ...
    function cpu_widget.set(freq, cpu_usage)
        cpu_widget:get_children_by_id("txt_cpu_freq")[1]:set_text(freq)
        cpu_widget:get_children_by_id("txt_cpu_usage")[1]:set_text(cpu_usage)
    end
