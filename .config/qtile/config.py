...
# <ALT> + KEYS
    ...
    KeyChord([alt], "m", [
        ...
        #  Key([], "r", lazy.spawn(f"{home}/.myScripts/dmenu/dmenu-run-programs.sh"), desc="Run choice of most used utils"),
    ...
    Key([alt], "F4", lazy.spawn("ByeBye"), desc="Launch logout app 'ByeBye'"),
