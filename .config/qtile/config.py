...
# <SUPER> + <ALT> + KEYS
    ...
    Key([mod, alt], "d", lazy.spawn(f"dmenu_run -i -l 10 -nb '#32343D' -nf '#CFD6DF' -sb '#3D5E87' -sf '#F9F9F9' -p 'Run: ' -fn 'Ubuntu-17:normal'"), desc="Run dmenu"),  # Everforest
    ...
    Key([mod, alt], "y", lazy.spawn(f"{my_term} -e {SHELL} -c 'yazi --cwd-file ~/.config/yazi/cwd (cat ~/.config/yazi/cwd)'"), desc="Launch yazi"),
