...
# set PATH $PATH $HOME/.cargo/bin $HOME/.config/vifm/scripts $HOME/.emacs.d/bin $GHCUP_INSTALL_BASE_PREFIX/.ghcup/bin $HOME/Programs/Android_SDK/platform-tools  # PATH for exa in cargo and ...
